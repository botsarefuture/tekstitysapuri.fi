...
class Job:
    ...
    def __json__(self):
        return json.dumps({"file_path": self.file_path, "job_id": self.job_id, "status": self.status})
...
if __name__ == "__main__":
    ...
    response = client.transcribe_and_get_response("tallenne.m4a", model="base", job_id="123")
    print(response)
